...
(function() {
  var Mpeg1Muxer, STREAM_MAGIC_BYTES, VideoStream, events, util, ws, child_process;
  ...
  VideoStream.prototype.onSocketConnect = function(socket) {
    ...
    return socket.on("close", function(code, message) {
      // console.log(self.mpeg1Muxer.stream);
      // self.mpeg1Muxer.stream.kill('SIGHUP');
      // console.log(self.mpeg1Muxer.pid)
      // console.log('enter close')
      // self.mpeg1Muxer.stream.terminate();
